...
class QuickTextRenderer(CLIRenderer):
    ...
    def render(self, grid: interfaces.renderers.TreeGrid) -> None:
        ...
        # Ensure the output file descriptor is using UTF-8 encoding
        if hasattr(outfd, 'reconfigure'):
            outfd.reconfigure(encoding='utf-8')
        elif hasattr(outfd, 'encoding'):
            import codecs
            outfd = codecs.getwriter('utf-8')(outfd.buffer)
...
class CSVRenderer(CLIRenderer):
    ...
    def render(self, grid: interfaces.renderers.TreeGrid):
        ...
        """
        import io
        outfd = io.TextIOWrapper(sys.stdout.buffer, encoding='utf-8', errors='replace')
